...
@Path("/transaccion/libro/guardar")
...
public class GuardarLibroApi {
    ...
    public Response guardarLibroEnOracleAnotacionTransactional(
        ...
        RespuestaGuardadoOracle respuestaGuardadoOracle = libroService.guardarLibroOracle(libro);
    ...
    public Response guardarLibroQuarkusTransactionalEnOracle(
        ...
        RespuestaGuardadoOracle respuestaGuardadoOracle = libroService.guardarLibroTransaccional(libro);
